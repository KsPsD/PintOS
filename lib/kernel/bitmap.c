...
// 주어진 value 값을 기준으로 비교 false가 들어왔을떄 다 true면 리턴 false
...
//bitmap_contains 가 들어가 보면 반대로 해서 이렇게 마지막에 반대 값을 리턴함
//none은 true인지를 확인해서 false뜨면 true
